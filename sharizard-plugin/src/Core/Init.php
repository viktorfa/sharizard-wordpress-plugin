...
use SharizardWordpress\Admin as Admin;
use SharizardWordpress\Common as Common;
use SharizardWordpress\Customizer as Customizer;
use SharizardWordpress\Frontend as Frontend;
use SharizardWordpress\Shortcodes as Shortcodes;
...
if ( ! class_exists( Init::class ) ) {
	...
	class Init {
		...
		private function define_public_hooks(): void {
			...
			$meta_tags = new Frontend\MetaTags();
