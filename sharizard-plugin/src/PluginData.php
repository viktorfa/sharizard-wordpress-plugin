...
if ( ! class_exists( PluginData::class ) ) {
	...
	class PluginData {
		 ...
		 *
		 * @return string 'sharizard_wp_plugin'
		 */
		 ...
		 * Example: /app/public/wp-content/plugins/sharizard-wordpress/
		 *
		 * @return string
		 */
		 ...
		 *
		 * Example: https://example.com/wp-content/plugins/sharizard-wordpress/
		 *
		 * @return string
		 */
		 ...
		 *
		 * @return string 'sharizard-wordpress/sharizard-wordpress.php'
		 */
