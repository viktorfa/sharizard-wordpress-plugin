...
use SharizardWordpress\Common\Utilities as Utils;
	...
	class Choices {
		...
		public function get_social_networks_data( $retrieve = '' ): array {
			$networks = [
				[
					'key'   => 'facebook',
					'name'  => esc_html__( 'Facebook', 'sharizard-wordpress' ),
					'color' => '#3b5998',
				],
				[
					'key'   => 'twitter',
					'name'  => esc_html__( 'Twitter', 'sharizard-wordpress' ),
					'color' => '#00aced',
				],
				[
					'key'   => 'pinterest',
					'name'  => esc_html__( 'Pinterest', 'sharizard-wordpress' ),
					'color' => '#BD081C',
				],
				[
					'key'   => 'linkedin',
					'name'  => esc_html__( 'LinkedIn', 'sharizard-wordpress' ),
					'color' => '#007bb6',
				],
			];
